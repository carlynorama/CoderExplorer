...
final class CodeableStringExample:XCTestCase {
    ...
    func testExample() throws {
        ...
        XCTAssertEqual("number:12/sub.numeral:34/sub.string:world/text:hello", try SimpleCoder.encode(testItem))
...
"""
            let stringsFile = try SimpleCoder.encode(iPhone)
...
"""
        ...
        let appleStore = Store(
            ...
            let stringsFile = try SimpleCoder.encode(appleStore)
        XCTAssertEqual(output, stringsFile)
